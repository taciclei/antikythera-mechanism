...
- **Dimostrato formalmente in Lean 4.** [`lean/`](lean/README.md) contiene 193 teoremi, verificati dal kernel di Lean con Mathlib, senza alcun `sorry`:
  - la cinematica delle velocità medie ha esattamente **un grado di libertà**, e ogni velocità discende dai numeri di denti;
  - valgono i 22 rapporti obiettivo, così come i cicli metonico, del Saros, dell'Exeligmos, callippico e delle Olimpiadi e le relazioni tra i periodi planetari;
  - i 37 interassi sono corretti entro 10⁻⁶ mm;
  - i meccanismi a perno e asola conservano le loro velocità medie, e l'ampiezza dell'anomalia lunare è compresa tra 6.579° e 6.581°.

  I test di mutazione mostrano che Lean rifiuta un numero di denti errato, un rapporto obiettivo errato o un asse fuori posto.
...
### Verificare le dimostrazioni formali (Lean 4)

Installare [elan](https://lean-lang.org/install) una sola volta, poi:
...
[`lean/README.md`](lean/README.md) elenca ciò che è dimostrato, modulo per modulo, e ciò che non lo è.
...
8. **Dimostrazioni formali.** `tools/make_lean.py` traduce la specifica in Lean 4. La cinematica, i rapporti obiettivo e gli interassi sono dimostrati a partire da essa. Moduli scritti a mano aggiungono l'analisi dei perni-asola e l'astronomia, e revisori avversariali e test di mutazione hanno verificato che ogni enunciato affermi davvero ciò che dichiara.
...
- Le dimostrazioni in Lean coprono la cinematica delle velocità medie, i rapporti obiettivo, gli interassi e le leggi dei perni-asola e dei cedenti. Rapporto di condotta, sovrapposizione delle fasce, sottotaglio e collisioni sono verificati dagli strumenti Python e in Blender, non in Lean.
